...
def main():
    ...
    parser.add_argument('src', help='src model path or url', default="/mnt/petrelfs/liqingyun/deit/pretrained/B_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.01-res_224.npz")
    # The dst path must be a full path of the new checkpoint.
    parser.add_argument('dst', help='save path', default="/mnt/petrelfs/liqingyun/deit/pretrained/B_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.01-res_224.pth")
    ...
    pprint(list(jax_weights.keys()))
    print("\n\n")
    pprint(list(torch_weights.keys()))
