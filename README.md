...
|   PIIP-LH6B   | Mask R-CNN |      1536/1024/512      |  1x  |    `running`    |    `running`    | - |   -   |                                                       [log](https://huggingface.co/OpenGVLab/PIIP/raw/main/detection/mask_rcnn_internvit_lh6b_1536_1024_512_fpn_1x_coco_bs32_ms.log.json) \| [ckpt](https://huggingface.co/OpenGVLab/PIIP/resolve/main/detection/mask_rcnn_internvit_lh6b_1536_1024_512_fpn_1x_coco_bs32_ms.pth?download=true) \| [cfg](mmdetection/configs/piip/3branch/mask_rcnn_internvit_lh6b_1536_1024_512_fpn_1x_coco_bs32_ms.py)                                                       |
...
| PIIP-H6B | DINO |     MAE (L) + InternVL (6B)    | 1024/768 |  1x  |  `running`  |  -  |     [log](https://huggingface.co/OpenGVLab/PIIP/raw/main/detection/dino_4scale_internvit_h6b_1024_768_fpn_1x_coco_bs16_ms.log.json) \| [ckpt](https://huggingface.co/OpenGVLab/PIIP/resolve/main/detection/dino_4scale_internvit_h6b_1024_768_fpn_1x_coco_bs16_ms.pth?download=true) \| [cfg](mmdetection/configs/piip/2branch/dino_4scale_internvit_h6b_1024_768_fpn_1x_coco_bs16_ms.py)     |
| PIIP-LH6B | DINO |    DeiT III (L, 384) + MAE (L) + InternVL (6B)    | 1536/1024/512 |  2x  |  `running`  |  -  |     [log](https://huggingface.co/OpenGVLab/PIIP/raw/main/detection/dino_4scale_internvit_lh6b_1536_1024_512_fpn_2x_coco_bs32_ms.log.json) \| [ckpt](https://huggingface.co/OpenGVLab/PIIP/resolve/main/detection/dino_4scale_internvit_lh6b_1536_1024_512_fpn_2x_coco_bs32_ms.pth?download=true) \| [cfg](mmdetection/configs/piip/3branch/dino_4scale_internvit_lh6b_1536_1024_512_fpn_2x_coco_bs32_ms.py)     |

**Note**: i) we report the number of parameters and FLOPs of the backbone; ii) re-training results in slightly different performance from the original paper.
