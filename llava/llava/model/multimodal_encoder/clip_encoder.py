...
class CLIPVisionTower(nn.Module):
    ...
    def load_model(self, device_map=None):
        # assert is_intern_vit_6b_model(self.vision_tower_name) or "clip-vit-large" in self.vision_tower_name
        ...
        assert "clip-vit" in self.vision_tower_name
        crop_size = 336
        self.image_processor = CLIPImageProcessor.from_pretrained(self.vision_tower_name, crop_size=crop_size, size=crop_size)
    ...
    def unfreeze_all(self):
        ...
        print("!!! Unfreeze all layers of CLIP encoder")
