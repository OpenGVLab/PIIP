...
#! Path of vision tower (python config)
VISION_TOWER=configs/7f_piip-llava_clip-bl_512-448.py
...
tmp="${VISION_TOWER#configs/}"
RUN_NAME="${tmp%.py}_${LLM}_pretrain_1node_${ZERO}"
